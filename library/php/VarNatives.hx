...
class VarNatives
{
	...
	public static inline function is_callable(var_:Dynamic, ?syntax_only:Bool=false, ?callable_name:String) : Bool return untyped __call__('is_callable', var_, syntax_only, callable_name);
	...
	public static inline function print_r(expression:Dynamic, ?return_:Bool=false) : Dynamic return untyped __call__('print_r', expression, return_);
	...
	public static inline function var_export(expression:Dynamic, ?return_:Bool=false) : Dynamic return untyped __call__('var_export', expression, return_);
