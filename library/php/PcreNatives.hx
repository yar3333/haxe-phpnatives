...
class PcreNatives
{
	...
	public static inline function preg_match_all(pattern:String, subject:String, ?matches:NativeArray, ?flags:Int, offset=0) : Int return untyped __call__('preg_match_all', pattern, subject, matches, flags, offset);
	...
	public static inline function preg_replace(pattern:Dynamic, replacement:Dynamic, subject:T, ?limit:Int=-1, ?count:Int) : T return untyped __call__('preg_replace', pattern, replacement, subject, limit, count);
