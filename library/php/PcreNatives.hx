...
class PcreNatives
{
	...
	public static inline function preg_replace<T>(pattern:Dynamic, replacement:Dynamic, subject:T, ?limit:Int=-1) : T return untyped __call__('preg_replace', pattern, replacement, subject, limit);
	
	public static inline function preg_replace_ex<T>(pattern:Dynamic, replacement:Dynamic, subject:T, ?limit:Int=-1, count:Int) : T return untyped __call__('preg_replace', pattern, replacement, subject, limit, count);
