...
class Native
{
	...
	public static inline function array_change_key_case(arr:NativeArray, ?case:Int = CASE_LOWER) : NativeArray return untyped __call__('array_change_key_case', arr, case);
	...
	public static inline function unset(var_:Dynamic, ?Dynamic $+++) : Void return untyped __call__('unset', var_, Dynamic $+++);
	public static inline function array_chunk(arr:NativeArray, size:Int, ?preserve_keys:Bool = Bool) : NativeArray return untyped __call__('array_chunk', arr, size, preserve_keys);
	...
	public static inline function array_diff_assoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_diff_assoc', array1, array2, arr $+++);
	public static inline function array_diff_key(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_diff_key', array1, array2, arr $+++);
	public static inline function array_diff_uassoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , key_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_diff_uassoc', array1, array2, arr $+++, key_compare_func);
	public static inline function array_diff_ukey(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , key_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_diff_ukey', array1, array2, arr $+++, key_compare_func);
	public static inline function array_diff(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_diff', array1, array2, arr $+++);
	...
	public static inline function array_intersect_assoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_intersect_assoc', array1, array2, arr $+++);
	public static inline function array_intersect_key(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_intersect_key', array1, array2, arr $+++);
	public static inline function array_intersect_uassoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , key_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_intersect_uassoc', array1, array2, arr $+++, key_compare_func);
	public static inline function array_intersect_ukey(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , key_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_intersect_ukey', array1, array2, arr $+++, key_compare_func);
	public static inline function array_intersect(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_intersect', array1, array2, arr $+++);
	...
	public static inline function array_keys(arr:NativeArray, ?search_value:Dynamic = null, ?strict:Bool = Bool) : NativeArray return untyped __call__('array_keys', arr, search_value, strict);
	public static inline function array_map(callback:callable, array1:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_map', callback, array1, arr $+++);
	public static inline function array_merge_recursive(array1:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_merge_recursive', array1, arr $+++);
	public static inline function array_merge(array1:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_merge', array1, arr $+++);
	public static inline function array_multisort(array1:NativeArray, ?array1_sort_order:Dynamic = SORT_ASC, ?array1_sort_flags:Dynamic = SORT_REGULAR, ?Dynamic $+++) : Bool return untyped __call__('array_multisort', array1:NativeArray, array1_sort_order, array1_sort_flags, Dynamic $+++);
	...
	public static inline function array_push(arr:NativeArray, value1:Dynamic, ?Dynamic $+++) : Int return untyped __call__('array_push', arr:NativeArray, value1, Dynamic $+++);
	...
	public static inline function array_replace_recursive(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_replace_recursive', array1, array2, arr $+++);
	public static inline function array_replace(array1:NativeArray, array2:NativeArray, ?NativeArray $+++) : NativeArray return untyped __call__('array_replace', array1, array2, arr $+++);
	public static inline function array_reverse(arr:NativeArray, ?preserve_keys:Bool = Bool) : NativeArray return untyped __call__('array_reverse', arr, preserve_keys);
	public static inline function array_search(needle:Dynamic, haystack:NativeArray, ?strict:Bool = Bool) : Dynamic return untyped __call__('array_search', needle, haystack, strict);
	public static inline function array_shift(arr:NativeArray) : Dynamic return untyped __call__('array_shift', arr:NativeArray);
	public static inline function array_slice(arr:NativeArray, offset:Int, ?length:Int, ?preserve_keys:Bool = Bool) : NativeArray return untyped __call__('array_slice', arr, offset, length, preserve_keys);
	array array_splice ( array &$input , int $offset [, int $length = 0 [, mixed $replacement = array() ]] )
	public static inline function array_sum(arr:NativeArray) : number return untyped __call__('array_sum', arr);
	public static inline function array_udiff_assoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , value_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_udiff_assoc', array1, array2, arr $+++, value_compare_func);
	public static inline function array_udiff_uassoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , value_compare_func:Dynamic->Dynamic->Int, key_compare_func:callable) : NativeArray return untyped __call__('array_udiff_uassoc', array1, array2, arr $+++, value_compare_func, key_compare_func);
	public static inline function array_udiff(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , value_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_udiff', array1, array2, arr $+++, value_compare_func);
	public static inline function array_uintersect_assoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , value_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_uintersect_assoc', array1, array2, arr $+++, value_compare_func);
	public static inline function array_uintersect_uassoc(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , value_compare_func:Dynamic->Dynamic->Int, key_compare_func:callable) : NativeArray return untyped __call__('array_uintersect_uassoc', array1, array2, arr $+++, value_compare_func, key_compare_func);
	public static inline function array_uintersect(array1:NativeArray, array2:NativeArray, ?NativeArray $+++ , value_compare_func:Dynamic->Dynamic->Int) : NativeArray return untyped __call__('array_uintersect', array1, array2, arr $+++, value_compare_func);
	...
	public static inline function array_unshift(arr:NativeArray, value1:Dynamic, ?Dynamic $+++) : Int return untyped __call__('array_unshift', arr:NativeArray, value1, Dynamic $+++);
	...
	public static inline function NativeArray(?Dynamic $+++) : NativeArray return untyped __call__('NativeArray', Dynamic $+++);
	...
	public static inline function compact(varname1:Dynamic, ?Dynamic $+++) : NativeArray return untyped __call__('compact', varname1, Dynamic $+++);
	...
	public static inline function list(var1:Dynamic, ?Dynamic $+++) : NativeArray return untyped __call__('list', var1, Dynamic $+++);
	...
	public static inline function debug_zval_dump(variable:Dynamic, ?Dynamic $+++) : Void return untyped __call__('debug_zval_dump', variable, Dynamic $+++);
	...
	public static inline function is_callable(var_:Dynamic, ?syntax_only:Bool = Bool, ?callable_name:String) : Bool return untyped __call__('is_callable', var_, syntax_only, callable_name:String);
	...
	public static inline function isset(var_:Dynamic, ?Dynamic $+++) : Bool return untyped __call__('isset', var_, Dynamic $+++);
	public static inline function print_r(expression:Dynamic, ?return:Bool = Bool) : Dynamic return untyped __call__('print_r', expression, return);
	...
	public static inline function unset(var_:Dynamic, ?Dynamic $+++) : Void return untyped __call__('unset', var_, Dynamic $+++);
	public static inline function var_dump(expression:Dynamic, ?Dynamic $+++) : Void return untyped __call__('var_dump', expression, Dynamic $+++);
	public static inline function var_export(expression:Dynamic, ?return:Bool = Bool) : Dynamic return untyped __call__('var_export', expression, return);
